...
if exists "$MOUNT/etc/init.d/asplashscreen" ; then
  execute "sed -i \"s/ *both/ alsa/\" $MOUNT/etc/init.d/asplashscreen"
fi
if exists "$MOUNT/opt/retropie/supplementary/splashscreen/asplashscreen.sh" ; then
  execute "sed -i \"s/ *both/ alsa/\" $MOUNT/opt/retropie/supplementary/splashscreen/asplashscreen.sh"
fi
