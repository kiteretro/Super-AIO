...
//  lcdData(0x1B);
//  lcdData(0xFF);
//  lcdData(0x00); //3 https://github.com/hiharin/snappro_xboot/blob/master/drivers/lcd.c
//  lcdData(0x4F);
//  lcdData(0x5F);
//  lcdData(0x72);
//  lcdData(0x33);
...
//  lcdData(0x1C);
//  lcdData(0x01);
//  lcdData(0x09); // 4 https://searchcode.com/file/47857269/drivers/video/msm/mipi_lead.c
//  lcdData(0x17);
//  lcdData(0x10);
//  lcdData(0x10);
//  lcdData(0x3e);
...
//  lcdData(0x53);
//  lcdData(0x19);
//  lcdData(0x00); // 5 http://crewrktablets.arctablet.com:8080/opendev/kernel_rockchip/raw/7424f6957e97894246d277369e4644bf2bbd111f/drivers/video/display/screen/lcd_hsd100pxn_for_tdw851.c
//  lcdData(0x1E);
//  lcdData(0x63);
//  lcdData(0x15);
//  lcdData(0x11);
